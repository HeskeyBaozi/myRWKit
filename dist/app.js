...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoItem = __webpack_require__(192);
	...
	var todoJson = {
	    filter: _actions.filterTypes.SHOW_ALL,
	    todos: [new _todoItem.todoItem('你好1', '这个是描述1', false, 0), new _todoItem.todoItem('你好2', '这个是描述2', true, 1), new _todoItem.todoItem('你好31', '这个是描述3', false, 0)]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoListMain = __webpack_require__(193);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_Header2.default, { addTask: this.props.addTask }),
	                _react2.default.createElement(_TodoListMain2.default, { todos: this.props.todos, filter: this.props.filter }),
	                _react2.default.createElement(_Footer2.default, { changeFilter: this.props.changeFilter, filter: this.props.filter })
	            );
	        }
	    }]);
	...
	App.propTypes = {
	    todos: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape(_todoItem.todoItemProtoTypesObj)),
	    filter: _react2.default.PropTypes.oneOf([_actions.filterTypes.SHOW_ACTIVE, _actions.filterTypes.SHOW_ALL, _actions.filterTypes.SHOW_COMPLETED]).isRequired
	};
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        addTask: function addTask(newTodoItemObj) {
	            return dispatch(_actions.actionFactory.addTodo(newTodoItemObj));
	        },
	        changeFilter: function changeFilter(newFilter) {
	            return dispatch(_actions.actionFactory.setVisibilityFilter(newFilter));
	        }
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_React$Component) {
	    ...
	    function Header(props) {
	        ...
	        _this.state = new _todoItem.todoItem('', 'None', false, 1);
	        return _this;
	    }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'form',
	                        { className: 'row', onSubmit: this.handleSubmit.bind(this) },
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-sm-8 form-group' },
	                            _react2.default.createElement(
	                                'label',
	                                { className: 'sr-only', htmlFor: 'addTaskInput' },
	                                'Add Task'
	                            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.todoItemProtoTypesObj = exports.todoItem = undefined;
	...
	var todoItem = exports.todoItem = function todoItem(title, description, isCompleted, importance) {
	...
	var todoItemProtoTypesObj = exports.todoItemProtoTypesObj = {
	    title: _react2.default.PropTypes.string.isRequired,
	    description: _react2.default.PropTypes.string.isRequired,
	    isCompleted: _react2.default.PropTypes.bool.isRequired,
	    importance: _react2.default.PropTypes.number.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoListMain = function (_React$Component) {
	    _inherits(TodoListMain, _React$Component);

	    function TodoListMain(props) {
	        _classCallCheck(this, TodoListMain);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TodoListMain).call(this, props));
	    }
	    ...
	    _createClass(TodoListMain, [{
	        ...
	        value: function render() {
	            ...
	            var todoDataJSXArray = this.props.todos.filter(function (val, index, array) {
	                switch (_this2.props.filter) {
	                    case _actions.filterTypes.SHOW_ALL:
	                        return true;
	                    case _actions.filterTypes.SHOW_ACTIVE:
	                        return val.isCompleted ? false : true;
	                    case _actions.filterTypes.SHOW_COMPLETED:
	                        return val.isCompleted ? true : false;
	                    default:
	                        throw Error('No case');
	                }
	            }).map(function (val, index, array) {
	                return _react2.default.createElement(_TodoItem2.default, { todoItemObj: val, key: index.toString() + 'hash' });
	            });
	            return _react2.default.createElement(
	                'main',
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(TodoItem, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'h3',
	                    { className: this.props.todoItemObj.isCompleted ? 'text-success' : 'text-danger' },
	                    _react2.default.createElement(
	                        'strong',
	                        null,
	                        this.props.todoItemObj.title,
	                        ' ',
	                        this.props.todoItemObj.isCompleted ? 'Completed' : 'Active'
	                    )
	                ),
	                _react2.default.createElement(
	                    'p',
	                    null,
	                    'des: ',
	                    this.props.todoItemObj.description
	                ),
	                _react2.default.createElement(
	                    'p',
	                    null,
	                    'importance: ',
	                    this.props.todoItemObj.importance
	                )
	            );
	        }
	    }]);
	...
	TodoItem.propTypes = {
	    todoItemObj: _react2.default.PropTypes.object.isRequired
	};
...
/***/ function(module, exports) {
	 ...
	 * action factory
	 */
	var actionFactory = exports.actionFactory = {
	    addTodo: function addTodo(todoItemObj) {
	        return {
	    ...
	    setVisibilityFilter: function setVisibilityFilter(newFilter) {
	        return {
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            { href: '#',
	                                ...
	                                id: _actions.filterTypes.SHOW_ALL },
	                            'All'
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            { href: '#',
	                                onClick: this.handleClick.bind(this),
	                                id: _actions.filterTypes.SHOW_ACTIVE },
	                            'Active'
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            { href: '#',
	                                onClick: this.handleClick.bind(this),
	                                id: _actions.filterTypes.SHOW_COMPLETED },
	                            'Completed'
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	function todos(todosArrayState, action) {
	    ...
	    switch (action.type) {
	        case _actions.actionTypes.ADD_TODO:
	            return [].concat(_toConsumableArray(todosArrayState), [action.todoItemObj]);
	        case _actions.actionTypes.COMPLETE_TODO:
	            return [].concat(_toConsumableArray(todosArrayState.slice(0, action.index)), [Object.assign({}, todosArrayState[action.index], { isCompleted: true })], _toConsumableArray(todosArrayState.slice(action.index + 1)));
	        default:
	...
	function visibilityFilter(filterState, action) {
	    if (typeof filterState === 'undefined') {
	        filterState = _actions.filterTypes.SHOW_ALL;
	    }
	    switch (action.type) {
	        case _actions.actionTypes.SET_VISIBILITY_FILTER:
